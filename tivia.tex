...
\begin{tikzpicture}[every node/.style={font=\sffamily}]
  ...
  \node[draw, fill=red!10, minimum width=3.5cm, minimum height=0.7cm, anchor=north] (integrations) at ([xshift=0cm,yshift=-0.7cm]process.south) {\footnotesize Custom Code};
...
\begin{frame}{Plone CMS with BPMN driven orchestration}
  \includegraphics[width=0.95\columnwidth]{images/submit-01.png}
\end{frame}
